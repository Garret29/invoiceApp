        ...
        <html>
            ...
            <body style="font-family:Arial">
                ...
                <xsl:for-each select="faktura/dostawca">
                    ...
                    <xsl:if test="dom = ''">dom:______</xsl:if>&#160;lok.
                    <xsl:if test="lokal !='' ">
                ...
                <xsl:for-each select="faktura">
                    <h2>
                        <p align="center">Faktura VAT
                            ...
                            <xsl:if test="not(id)"> ____________</xsl:if>
                            <xsl:if test="id = ''"> ____________</xsl:if>
                        </p>
                    </h2>
                </xsl:for-each>
                <table
                    ...
                    <xsl:for-each select="faktura/towary/towar">
                        <tr>
                            ...
                            <td align="right">
                                <xsl:value-of select="cena_netto_jednost" />
                            </td>
                            <td align="right">
                                <xsl:value-of select="rabat" />
                            </td>
                            <td align="right">
                                <xsl:value-of select="cena_netto_jednost_po_rabacie" />
                            </td>
                            <td align="right">
                            ...
                            <table
                                ...
                                <tr>
                                    <xsl:for-each select="faktura">
                                        <td>W tym:</td>
                                        <td align="right">
                                            <xsl:value-of select="netto_0" />
                                        </td>
                                        <td align="right">
                                            <xsl:value-of select="vat_0" />
                                        </td>
                                        <td align="right">0%</td>
                                        <td align="right">
                                            <xsl:value-of select="gross_0" />
                                        </td>
                                    </xsl:for-each>
                                </tr>
                                <tr>
                                    <xsl:for-each select="faktura">
                                        <td align="right" />
                                        <td align="right">
                                            <xsl:value-of select="netto_5" />
                                        </td>
                                        <td align="right">
                                            <xsl:value-of select="vat_5" />
                                        </td>
                                        <td align="right">5%</td>
                                        <td align="right">
                                            <xsl:value-of select="gross_5" />
                                        </td>
                                    </xsl:for-each>
                                </tr>
                                <tr>
                                    <xsl:for-each select="faktura">
                                        <td align="right" />
                                        <td align="right">
                                            <xsl:value-of select="netto_8" />
                                        </td>
                                        <td align="right">
                                            <xsl:value-of select="vat_8" />
                                        </td>
                                        <td align="right">8%</td>
                                        <td align="right">
                                            <xsl:value-of select="gross_8" />
                                        </td>
                                    </xsl:for-each>
                                </tr>
                                <tr>
                                    <xsl:for-each select="faktura">
                                        <td align="right" />
                                        <td align="right">
                                            <xsl:value-of select="netto_23" />
                                        </td>
                                        <td align="right">
                                            <xsl:value-of select="vat_23" />
                                        </td>
                                        <td align="right">23%</td>
                                        <td align="right">
                                            <xsl:value-of select="gross_23" />
                                        </td>
                                    </xsl:for-each>
                                </tr>
                            </table>
